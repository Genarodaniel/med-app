...
class PatientsDataTable extends DataTable
{
    ...
    public function html()
    {
        return $this->builder()
                    ...
                    ->buttons(
                        Button::make('create')->text('Novo Paciente'),
